  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      if (result) {
        ...
        alert("Query sent!,we will contact you soon!");
      }
    } catch (error) {
...
<div style={{alignItems:'center'}}>
        ...
        <TextField onChange={(e)=>setEmail(e.target.value)} style={{backgroundColor:'white',border:'30',marginRight:'320px',marginLeft:'30px',marginBottom:'10px',marginTop:'20px'}} placeholder='your Email' name='email'></TextField>
        <TextField onChange={(e)=>setQuery(e.target.value)}style={{backgroundColor:'white',border:'20',marginRight:'320px',marginLeft:'30px'}}placeholder='Enter your Query' name='query'> </TextField>
        <Button 
  style={{ backgroundColor: 'orange',border:'None', color: '#0a58ca' ,margin:'30px'}} 
